		...
		return (
			<div className='group-main'>
				<ul class='nav nav-tabs group' role='tablist'>
					<li class='nav-item'>
						<a class='nav-link active ' href='#managegroup' role='tab' data-toggle='tab'>
							<i class='fas fa-dot-circle' />&nbsp;Add Grps
						</a>
					</li>
					<li class='nav-item'>
						<a class='nav-link  size' href='#addgroup' role='tab' data-toggle='tab'>
							<i class='fas fa-dot-circle' />&nbsp;Manage Grps
						</a>
					</li>
				</ul>
				...
				<div class='tab-content'>
					...
					<div role='tabpanel' class='tab-pane active' id='managegroup'>
						...
						<button class='btn btn-primary btn-raised ' style={{ position: 'relative', left: '55px' }}>
							<i class='fas fa-archive ' style={{ marginRight: 5 }} />Save
						</button>
						<button class='btn btn-warning btn-raised ' style={{ position: 'relative', left: '65px' }}>
							<i class='fas fa-arrow-left' style={{ marginRight: 5 }} />Back
						</button>
					</div>
				</div>
				{/* add group here */}
