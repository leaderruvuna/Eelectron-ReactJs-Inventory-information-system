...
import '../../assets/css/tabs-css/products.scss';
      ...
      <div className="product-main">
        <ul class="nav nav-tabs user " role="tablist">
          <li class="nav-item ">
            <a
              ...
              data-toggle="tab"
            >
              <i class="fas fa-dot-circle"></i>&nbsp;Add Products
            </a>
          </li>
          <li class="nav-item ">
            <a
              ...
              data-toggle="tab"
            >
              <i class="fas fa-dot-circle"></i>&nbsp;Manage Prts
            </a>
          </li>
        </ul>
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane  " id="managepro">
            ...
            <table
              id="dtBasicExample"
              class="table table-striped table-bordered table-product"
              cellspacing="0"
            >
              ...
              <fieldset class="scheduler-border">
                ...
                <table class="table table-borderless" style={{ width: 600 }}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <label for="description" class="label-size">
                          Description:
                        </label>
                      </td>
                      <td>
