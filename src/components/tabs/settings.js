							...
							<table class='table table-borderless' style={{ width: 580 }}>
								...
								<tbody>
									<tr>
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='Leader ruvuna' />
										</td>
										<td>
											<label for='email' class='label-size'>
												Group:
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='Staff' />
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='ruv@gmail.com' />
										</td>
										<td>
											<label for='email' class='label-size'>
												Password:
										...
										<td>
											<input type='password' class='form-control input-size' id='email' value='password' />
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='Leader' />
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='Ruvuna' />
										</td>
										<td>
											<label for='email' class='label-size'>
												Phone:
										...
										<td>
											<input type='email' class='form-control input-size' id='email' value='0788093633' />
										</td>
									</tr>
