...
import '../../assets/css/tabs-css/brand.scss';
class Brands extends React.Component {
	render() {
		return (
			<div className='brand-main'>
				<button type='button' class='btn btn-primary group-button btn-raised'>
					<i class='fas fa-plus-square' style={{ marginRight: 5 }} />Add Brand
				</button>
				...
				<table
					...
					<tbody>
						<tr>
							...
							<td>Active</td>
							<td>
								<button type='button' class='btn btn-primary btn-xs btn-edit-del center-block'>
									<i class='fas fa-edit' />
								</button>
