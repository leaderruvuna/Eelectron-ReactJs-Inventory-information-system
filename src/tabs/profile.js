...
import "../css/tabs-css/profile.scss";
...
class Profile extends React.Component{
  render(){
    ...
    <td><input type="email" class="form-control input-size" id="email" value="" /></td>
    ...
    <td><input type="email" class="form-control input-size" id="email" value="" /></td>
      ...
      <td><input type="email" class="form-control input-size" id="email" value="" /></td>
      <td><label for="email" class="label-size">Phone Number:</label></td>
      <td><input type="password" class="form-control input-size" id="email" value="" /></td>
          
      </tr>
      
      <tr>
      <td><label for="email" class="label-size">Adress1:</label></td>
      <td><input type="password" class="form-control input-size" id="email" value="" /></td>
      <td><label for="email" class="label-size">Adress2:</label></td>
      <td><input type="email" class="form-control input-size" id="email" value="" /></td>
