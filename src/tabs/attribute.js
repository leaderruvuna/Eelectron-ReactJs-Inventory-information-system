...
import "../css/tabs-css/attribute.scss";
...
class Attribute extends React.Component{
  render(){
    return(
      ...
      <button type="button" class="btn btn-primary group-button btn-raised"><i class="fas fa-plus-square" style={{marginRight:5}}></i>Add Attr</button>
