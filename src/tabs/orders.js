...
import "../css/tabs-css/orders.css";
  ...
  render(){
    return(
      ...
      <li class="nav-item inner-tab">
        <a class="nav-link active" href="#addorder" role="tab" data-toggle="tab"><i class="fas fa-dot-circle"></i>&nbsp;Add Orders</a>
      </li>
      <li class="nav-item inner-tab">
        <a class="nav-link  size" href="#manageorder" role="tab" data-toggle="tab"><i class="fas fa-dot-circle"></i>&nbsp;Manage Orders</a>
      </li>
    ...
    <option value="3">50</option>
      ...
      <table id="dtBasicExample" class="table table-striped table-bordered order-table" cellspacing="0" width="">
        ...
        <tbody>
          ...
          <td>8</td>
          <td>Store 1</td>
          <td><label class="order-status">cash</label></td>
      ...
      <tbody>
        <tr>
          ...
          <td><label for="email " class="label-size">Customer Name:</label></td>
          <td><input type="email" class="form-control input-size" id="email"/></td>
          <td><label for="email" class="label-size">Customer Adrress:</label></td>
          <td><input type="email" class="form-control input-size" id="email"/></td>
        </tr>
      
        <tr>
        <td><label for="email" class="label-size">Customer Phone:</label></td>
        <td><input type="email" class="form-control input-size" id="email"/></td>
        <td><label for="email" class="label-size">Product:</label></td>
        <td>
        ...
        <select class="selectpicker "  data-style="btn border" data-show-subtext="true" data-live-search="true">
          ...
          <option data-subtext="" disabled="disabled">Keyboard</option>
        </select>
        ...
        <tr>
        <td><label for="email" class="label-size">Quantity:</label></td>
        <td><input type="email" class="form-control input-size" id="email"/></td>
        <td><label for="email" class="label-size">Rate:</label></td>
        <td><input type="email" class="form-control input-size" id="email" draggable disabled/></td>
           
        </tr>
        
        <tr>
        <td><label for="email" class="label-size">Amount:</label></td>
        <td><input type="email" class="form-control input-size" id="email" draggable disabled/></td>
        <td><label for="email" class="label-size">Gross Amount:</label></td>
        <td><input type="email" class="form-control input-size" id="email" draggable disabled/></td>
          
        </tr>
        
        <tr>
        <td><label for="email" class="label-size">Vat %:</label></td>
        <td><input type="email" class="form-control input-size" id="email" draggable disabled/></td>
        <td><label for="email" class="label-size">Net Amount:</label></td>
        <td><input type="email" class="form-control input-size" id="email" draggable disabled/></td> 
        </tr>
        ...
        <td></td>
        <td>
        <button  class="btn btn-primary btn-raised" ><i class="fas fa-archive " style={{marginRight:5}}></i>Create Order</button>
