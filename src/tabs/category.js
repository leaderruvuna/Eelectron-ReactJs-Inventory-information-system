...
import "../css/tabs-css/category.scss";
...
class Category extends React.Component{
  render(){
    return(
      ...
      <button type="button" class="btn btn-primary group-button btn-raised"><i class="fas fa-plus-square" style={{marginRight:5}}></i>Add Category</button>
